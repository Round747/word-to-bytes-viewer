...
All the other bit viewers online did not let you view the 8-bit value of the second byte within a word. Since My project split words into to bytes, i needed to see what the 16-bit value was with the combination of two decimals.
